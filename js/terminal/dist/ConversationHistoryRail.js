...
export const ConversationHistoryRail = memo(function ConversationHistoryRail({ agentStatus, conversations, error, mobileOpen, onClose, onCreate, onOpen, onRetry, onSelect, pending, runtime, selectedId, }) {
    ...
    return _jsxs(_Fragment, { children: [_jsx("div", { className: mobileOpen ? "conversation-backdrop is-visible" : "conversation-backdrop", "aria-hidden": "true", onPointerDown: onClose }), _jsxs("aside", { className: mobileOpen ? "conversation-sidebar is-mobile-open" : "conversation-sidebar", "aria-labelledby": "conversation-history-title", role: mobileOpen ? "dialog" : "complementary", "aria-modal": mobileOpen || undefined, children: [_jsxs("header", { className: "conversation-sidebar-header", children: [_jsxs("div", { children: [_jsx("strong", { id: "conversation-history-title", children: "Conversations" }), _jsxs("span", { children: [_jsx(MessageSquare, { "aria-hidden": "true" }), " ", runtime === "local" ? "this browser" : "managed account"] })] }), _jsxs("nav", { className: "conversation-sidebar-actions", "aria-label": "Conversation actions", children: [onCreate ? _jsx("button", { className: "conversation-icon-button", type: "button", disabled: pending, "aria-label": "New conversation", title: "New conversation", onClick: onCreate, children: _jsx(Plus, { "aria-hidden": "true" }) }) : null, _jsx("button", { ref: closeRef, className: "conversation-drawer-close", type: "button", "aria-label": "Close conversations", onClick: onClose, children: _jsx(X, { "aria-hidden": "true" }) })] })] }), _jsxs("div", { className: "conversation-list", children: [conversations.map((conversation) => {
                                const active = conversation.id === selectedId;
                                const title = conversationDisplayTitle(conversation.title);
                                return _jsxs("button", { className: active ? "conversation-row is-selected" : "conversation-row", type: "button", "aria-current": active ? "location" : undefined, onClick: () => onSelect(conversation.id), children: [_jsx("strong", { children: title }), _jsxs("span", { className: "conversation-row-meta", children: [_jsx("span", { children: relativeTime(conversation.updatedAt) }), _jsx("span", { "aria-hidden": "true", children: "\u00B7" }), _jsx("span", { children: conversation.turnCount === undefined
