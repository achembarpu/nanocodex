...
mod tests {
    ...
    fn benchmark_prompt_admits_workers_from_live_host_capacity() {
        ...
        assert!(prompt.contains("never `continue` directly from a spawn"));
