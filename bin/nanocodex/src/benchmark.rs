...
5. Unless pressure is elevated or a worker just vanished, wait at least 45 seconds before the next compact observation so useful work can complete. Let existing workers drain under overload; never stop, signal, or shed one manually.
