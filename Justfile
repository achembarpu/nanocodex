...
release-check version:
    ...
    bash -n install scripts/changelog.sh scripts/check-crate-boundaries.sh scripts/check-docs.sh scripts/check-rustls-provider.sh scripts/publish-crates.sh scripts/release-crates.sh scripts/test-install.sh
