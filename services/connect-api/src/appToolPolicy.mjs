...
export function isAllowedAppToolCatalogResource(resource) {
  return typeof resource === "string"
    && new RegExp(`^${APP_TOOL_CATALOG_RESOURCE_PREFIX}[0-9a-f]{64}$`).test(resource);
}

export function appToolCatalogDigestFromResources(resources) {
...
export function isChromeExtensionGrantResources(resources, appId, origin) {
